...
- Given that each connection occupies 2 file descriptors, this server can handle no more than around 500 connections without exhausting more than 1024. This means: we need a way to reject incoming connections if the server reached that limit, instead of just crashing. Maybe reject with a 529.
- Refactor this code:
